...
function stepThrough(leftNode, rightNode, comparator, debug = false) {
  ...
  /*
    When the leftNode is a power node, try to take the nthRoot of both sides
    e.g. (y + 1)^3 = 1 -> nthRoot((y + 1)^3, 3) = nthRoot(1, 3)
  */
  if (Node.Type.isOperator(equation.leftNode, '^')) {
    equationStatus = EquationOperations.isolateSymbolOnLeftSide(equation, symbolName)
