...
const poolOfRules = [
  ...
  // addLikeTerms: coeff + fract
  {l: 'n    + n/c'  , r: '(1 + 1/c) * n'     , id: ChangeTypes.COLLECT_AND_COMBINE_LIKE_TERMS},
  {l: 'n/c  + n'    , r: '(1/c + 1) * n'     , id: ChangeTypes.COLLECT_AND_COMBINE_LIKE_TERMS},
  {l: 'n/c1 + n/c2' , r: '(1/c1 + 1/c2) * n' , id: ChangeTypes.COLLECT_AND_COMBINE_LIKE_TERMS},

  {l: 'c1*n + n/c2' , r: '(c1 + 1/c2) * n'  , id: ChangeTypes.COLLECT_AND_COMBINE_LIKE_TERMS},
  {l: 'n/c1 + c2*n' , r: '(1/c1 + c2) * n'  , id: ChangeTypes.COLLECT_AND_COMBINE_LIKE_TERMS},

  // addLikeTerms: fract + fract
  {l: 'n       + c2/c3*n' , r: '(1 + c2/c3) * n'     , id: ChangeTypes.COLLECT_AND_COMBINE_LIKE_TERMS},
  {l: 'c1*n    + c2/c3*n' , r: '(c1 + c2/c3) * n'    , id: ChangeTypes.COLLECT_AND_COMBINE_LIKE_TERMS},
  {l: 'c1/c2*n + c3*n'    , r: '(c1/c2 + c3) * n'    , id: ChangeTypes.COLLECT_AND_COMBINE_LIKE_TERMS},
  {l: 'c1/c2*n + c3/c4*n' , r: '(c1/c2 + c3/c4) * n' , id: ChangeTypes.COLLECT_AND_COMBINE_LIKE_TERMS},
