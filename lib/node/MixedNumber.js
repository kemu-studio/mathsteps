...
function isMixedNumber(node) {
  ...
  const numeratorSecondArg = numerator.args[1]
...
function getNumeratorValue(node) {
  ...
  const numeratorNode = node.args[0].args[1]
  return numeratorNode.value
}
