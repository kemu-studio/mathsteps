...
describe('simplify nthRoot', function () {
  const tests = [
    ['nthRoot(4)', '2'],
    ['nthRoot(8, 3)', '2'],
    ['nthRoot(5 * 7)', 'sqrt(5 * 7)'],
    ['nthRoot(4, 3)', 'nthRoot(4, 3)'],
    ['nthRoot(12)', '2 * sqrt(3)'],
    ['nthRoot(36)', '6'],
    ['nthRoot(72)', '2 * 3 * sqrt(2)'],
    ['nthRoot(x^2)', 'x'],
    ['nthRoot(x ^ 3)', 'sqrt(x^3)'],
    ['nthRoot(x^3, 3)', 'x'],
    ['nthRoot(-2)', 'sqrt(-2)'],
    ['nthRoot(2 ^ x, x)', '2'],
    ['nthRoot(x ^ (1/2), 1/2)', 'x'],
    ...
    ['nthRoot(36*x)', '2 * 3 * sqrt(x)'],
    ['nthRoot(2 * 18 * x ^ 2, 2)', '2 * 3 * x'],
    ['nthRoot(x * x, 2)', 'x'],
    ['nthRoot(x * x * (2 + 3), 2)', 'x * sqrt(2 + 3)'],
    ['nthRoot(64, 3)', '4'],
    ['nthRoot(35937, 3)', '33'],
  ]
